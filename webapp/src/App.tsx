...
// import type { Track as ToneTrack } from '@tonejs/midi/dist/Track';
...
// function buildNoteList(midi: Midi, { trimLeadingSilence = false }: { trimLeadingSilence?: boolean } = {}): NoteEvent[] {
...
// function buildTrackEvents(midi: Midi, { trimLeadingSilence = false }: { trimLeadingSilence?: boolean } = {}): TrackEvent[] {
