    ...
    <ErrorBoundary>
      ...
      >
        ...
        <p className="hint output-summary">
          ...
          Harmonics are connected by a vertical redstone rail on the left. An orange T-junction cell
          marks where a lane branches off another lane to save repeaters. Drag the gold vertical
          marker to track column progress; drag the blue horizontal marker to track row progress.
