              ...
              {tutorialOpen && (
                <div className="schematic-tutorial-body">
                  <p className="schematic-tutorial-note">
                    ...
                    redstone needs to be wired. It shows only the timeline and repeater delays.
                    Wiring multiple note blocks to play at the same time requires more redstone,
                    as shown in the example pictures below.
                  </p>
